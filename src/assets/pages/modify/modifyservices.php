<form id="form" action="POST" class="alert  alert-dismissible fade show animate__bounceIn shadow needs-validation" role="alert" novalidate>
  ...
  <strong class="fs-2">Service Modification</strong>


    <div class="container container-services">
        <div class="mb-3 w-100">
            <div class="col-12 position-relative">
                <label for="name_service" class="form-label">Name</label>
                <input name="name" type="text" class="form-control" id="name_service" placeholder="Service Name" required disabled>
    ...
    <button type="submit" class="btn btn-primary fs-3 d-flex align-items-center gap-2">
      ...
      <span role="status">Update Service</i></span>
