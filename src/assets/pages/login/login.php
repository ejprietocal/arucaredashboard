<form class="form_container animate__bounceIn" method="POST">
  ...
  <div class="input_container">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#141B34" class="icon2">
